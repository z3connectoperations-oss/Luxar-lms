  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 px-5 py-14 text-ink">
      ...
      <div className="space-y-4 text-muted leading-relaxed">
        <p>
          Welcome to Luxaar Institute. By continuing to browse and use this website and application, you are agreeing to comply with and be bound by the following terms and conditions of use, which, together with our Privacy Policy, govern <strong>Luxaar Institute</strong>'s relationship with you regarding this platform.
        </p>
        <p>
          The terms "Luxaar Institute," "us," or "we" refer to the owner of the website and application. The term "you" refers to the user or viewer of our platform.
        </p>
